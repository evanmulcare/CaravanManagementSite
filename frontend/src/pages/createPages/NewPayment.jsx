...
return <div className='m-2 md:m-10 p-2 md:p-10 bg-white rounded-3xl grid h-screen place-items-center'>
        ...
        <h1 className='text-2xl font-bold mb-5 mt-5'>Add a new Payment!</h1>
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
         ...
         <div class="w-full">
            ...
            <input onChange={handleChange} name="caravanid" value={input.caravanid} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="C01" required/>
         </div>
